...
class GenericMethods { // 일반클래스 안에 정의한 제네릭 메서드 예제
    public int method0(int a) { //일반메서드
        return a;
    }
    public <T> T method1(T t) { // 제네릭 메서드
        return t;
    }
    public <T> boolean method2(T t1, T t2) { //한 개의 제네릭타입
        return t1.equals(t2);
    }
    public <K,V> void method3(K k, V v) { //두 개의 제네릭타입을 사용
