...
public class Example {
    public static void main(String[] args) {
        ...
        // 힌트 : 새터메서드를 만들어야 함. toString()는 오버라이딩 필요.
        ...
        // 2.
        //아래 메서드를 완성하시오
        //주어진 배열을 이용하여 Student 타입의 배열을 만들고 for문으로 출력해야함
        createStudentsInfo();
    }
    ...
    public static void createStudentsInfo() {
        ...
        // Students 객체 형태로 만들고 이를 배열에 담는다.

        /*Students[] stdInfo = new Students[names.length];

        for (int i = 0; i < stdInfo.length ; i++) {
            stdInfo[i] = new Students(names[i], departments[i], studentsIds[i]);
